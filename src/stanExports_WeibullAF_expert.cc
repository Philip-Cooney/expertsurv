...
#include "stanExports_WeibullAF_expert.h"

RCPP_MODULE(stan_fit4WeibullAF_expert_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_WeibullAF_expert")
