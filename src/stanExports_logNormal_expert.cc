...
#include "stanExports_logNormal_expert.h"

RCPP_MODULE(stan_fit4logNormal_expert_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_logNormal_expert")
