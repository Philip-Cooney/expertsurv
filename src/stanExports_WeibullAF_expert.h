...
namespace model_WeibullAF_expert_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_WeibullAF_expert");
    reader.add_event(215, 213, "end", "model_WeibullAF_expert");
    return reader;
}
...
class model_WeibullAF_expert
  : public stan::model::model_base_crtp<model_WeibullAF_expert> {
private:
        int n;
        vector_d t;
        vector_d d;
...
public:
    model_WeibullAF_expert(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_WeibullAF_expert_namespace::model_WeibullAF_expert";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_WeibullAF_expert_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_WeibullAF_expert_namespace::model_WeibullAF_expert stan_model;
#ifndef USING_R
