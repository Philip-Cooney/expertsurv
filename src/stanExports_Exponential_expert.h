...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(177, 175, "end", "model_Exponential_expert");
    return reader;
}
...
template <typename T0__, typename T1__>
typename boost::math::tools::promote_args<T0__, T1__>::type
Surv_diff(const T0__& rate_trt,
              const T1__& rate_comp, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__, T1__>::type local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    (void) propto__;
...
struct Surv_diff_functor__ {
    template <typename T0__, typename T1__>
        typename boost::math::tools::promote_args<T0__, T1__>::type
    operator()(const T0__& rate_trt,
              const T1__& rate_comp, std::ostream* pstream__) const {
...
surv_exponential_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
                          ...
                          const Eigen::Matrix<T2__, Eigen::Dynamic, 1>& rate,
                          const Eigen::Matrix<T3__, Eigen::Dynamic, 1>& a0, std::ostream* pstream__) {
...
surv_exponential_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
                          ...
                          const Eigen::Matrix<T2__, Eigen::Dynamic, 1>& rate,
                          const Eigen::Matrix<T3__, Eigen::Dynamic, 1>& a0, std::ostream* pstream__) {
    return surv_exponential_lpdf<false>(t,d,rate,a0, pstream__);
}
struct surv_exponential_lpdf_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
                          const Eigen::Matrix<T1__, Eigen::Dynamic, 1>& d,
                          const Eigen::Matrix<T2__, Eigen::Dynamic, 1>& rate,
                          const Eigen::Matrix<T3__, Eigen::Dynamic, 1>& a0, std::ostream* pstream__) const {
...
class model_Exponential_expert
  : public stan::model::model_base_crtp<model_Exponential_expert> {
private:
        int n;
        vector_d t;
        vector_d d;
...
public:
    ...
    std::string model_name() const {
        return "model_Exponential_expert";
    }
...
typedef model_Exponential_expert_namespace::model_Exponential_expert stan_model;
#ifndef USING_R
