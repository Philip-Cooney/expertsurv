...
namespace model_logLogistic_expert_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_logLogistic_expert");
    reader.add_event(195, 193, "end", "model_logLogistic_expert");
    return reader;
}
...
Sind(const T0__& t,
    ...
    try {
        ...
        stan::math::assign(Sind, stan::math::exp(-(stan::math::log((1 + pow((t / scale), shape))))));
...
struct Sind_functor__ {
    ...
    operator()(const T0__& t,
        ...
        return Sind(t, shape, scale, pstream__);
    }
};
template <typename T0__, typename T1__, typename T2__>
typename boost::math::tools::promote_args<T0__, T1__, T2__>::type
Surv_diff(const T0__& shape,
    ...
    try {
        ...
        stan::math::assign(b, (stan::math::pi() / shape));
        current_statement_begin__ = 34;
        stan::math::assign(Surv_diff, (((scale_trt - scale_comp) * b) / stan::math::sin(b)));
...
surv_loglogistic_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
                          ...
                          const Eigen::Matrix<T3__, Eigen::Dynamic, 1>& scale,
                          const Eigen::Matrix<T4__, Eigen::Dynamic, 1>& a0, std::ostream* pstream__) {
    return surv_loglogistic_lpdf<false>(t,d,shape,scale,a0, pstream__);
}
struct surv_loglogistic_lpdf_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
        ...
        return surv_loglogistic_lpdf(t, d, shape, scale, a0, pstream__);
    }
};
...
class model_logLogistic_expert
  : public stan::model::model_base_crtp<model_logLogistic_expert> {
private:
        int n;
        vector_d t;
        vector_d d;
...
public:
    model_logLogistic_expert(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_logLogistic_expert_namespace::model_logLogistic_expert";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= n_time_expert; ++i) {
                ...
                if (as_bool(logical_eq(St_indic, 1))) {
                    ...
                    stan::model::assign(St_expert, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                Sind(get_base1(time_expert, i, "time_expert", 1), alpha, get_base1(mu, id_St, "mu", 1), pstream__), 
            ...
            if (as_bool(expert_plus_data)) {
                ...
                lp_accum__.add(surv_loglogistic_lpdf<propto__>(t, d, alpha, mu, a0, pstream__));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_logLogistic_expert_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_logLogistic_expert";
    }
...
typedef model_logLogistic_expert_namespace::model_logLogistic_expert stan_model;
#ifndef USING_R
