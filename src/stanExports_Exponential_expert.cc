...
#include "stanExports_Exponential_expert.h"

RCPP_MODULE(stan_fit4Exponential_expert_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_Exponential_expert")
