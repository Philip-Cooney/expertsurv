...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(179, 177, "end", "model_RP_expert");
    return reader;
}
...
private:
        ...
        vector_d beta_lower;
        vector_d beta_upper;
        vector_d gamma_lower;
        vector_d gamma_upper;
        int n_time_expert;
        int St_indic;
        int id_St;
        int id_trt;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("gamma_lower", "(M + 2)", (M + 2));
            context__.validate_dims("data initialization", "gamma_lower", "vector_d", context__.to_vec((M + 2)));
            gamma_lower = Eigen::Matrix<double, Eigen::Dynamic, 1>((M + 2));
            vals_r__ = context__.vals_r("gamma_lower");
            pos__ = 0;
            size_t gamma_lower_j_1_max__ = (M + 2);
            for (size_t j_1__ = 0; j_1__ < gamma_lower_j_1_max__; ++j_1__) {
                gamma_lower(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 111;
            validate_non_negative_index("gamma_upper", "(M + 2)", (M + 2));
            context__.validate_dims("data initialization", "gamma_upper", "vector_d", context__.to_vec((M + 2)));
            gamma_upper = Eigen::Matrix<double, Eigen::Dynamic, 1>((M + 2));
            vals_r__ = context__.vals_r("gamma_upper");
            pos__ = 0;
            size_t gamma_upper_j_1_max__ = (M + 2);
            for (size_t j_1__ = 0; j_1__ < gamma_upper_j_1_max__; ++j_1__) {
                gamma_upper(j_1__) = vals_r__[pos__++];
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(uniform_log<propto__>(gamma, gamma_lower, gamma_upper));
