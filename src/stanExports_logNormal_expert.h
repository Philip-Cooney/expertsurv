...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_logNormal_expert");
    reader.add_event(205, 203, "end", "model_logNormal_expert");
    return reader;
}
...
log_Sind(const T0__& t,
    ...
    try {
        ...
        stan::math::assign(log_Sind, stan::math::log((1 - Phi(((stan::math::log(t) - mean) / sd)))));
...
template <typename T0__, typename T1__, typename T2__>
typename boost::math::tools::promote_args<T0__, T1__, T2__>::type
Surv_diff(const T0__& mean_trt,
              const T1__& mean_comp,
              const T2__& sd, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__, T1__, T2__>::type local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    ...
    try {
        ...
        local_scalar_t__ Surv_trt(DUMMY_VAR__);
        (void) Surv_trt;  // dummy to suppress unused var warning
        stan::math::initialize(Surv_trt, DUMMY_VAR__);
        stan::math::fill(Surv_trt, DUMMY_VAR__);
        current_statement_begin__ = 24;
        local_scalar_t__ Surv_comp(DUMMY_VAR__);
        (void) Surv_comp;  // dummy to suppress unused var warning
        stan::math::initialize(Surv_comp, DUMMY_VAR__);
        stan::math::fill(Surv_comp, DUMMY_VAR__);
        current_statement_begin__ = 26;
        stan::math::assign(Surv_trt, stan::math::exp((mean_trt + (0.5 * pow(sd, 2)))));
        current_statement_begin__ = 27;
        stan::math::assign(Surv_comp, stan::math::exp((mean_comp + (0.5 * pow(sd, 2)))));
        current_statement_begin__ = 29;
        stan::math::assign(Surv_diff, (Surv_trt - Surv_comp));
...
log_h(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
    ...
    try {
        ...
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> ls(num_elements(t));
...
surv_lognormal_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
                        ...
                        const T3__& sd,
                        const Eigen::Matrix<T4__, Eigen::Dynamic, 1>& a0, std::ostream* pstream__) {
    return surv_lognormal_lpdf<false>(t,d,mean,sd,a0, pstream__);
}
struct surv_lognormal_lpdf_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
        ...
        return surv_lognormal_lpdf(t, d, mean, sd, a0, pstream__);
    }
};
...
class model_logNormal_expert
  : public stan::model::model_base_crtp<model_logNormal_expert> {
private:
        int n;
        vector_d t;
        vector_d d;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= n_time_expert; ++i) {
                ...
                if (as_bool(logical_eq(St_indic, 1))) {
                    ...
                    stan::model::assign(St_expert, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                stan::math::exp(log_Sind(get_base1(time_expert, i, "time_expert", 1), get_base1(mu, id_St, "mu", 1), alpha, pstream__)), 
                                "assigning variable St_expert");
                } else {
                    current_statement_begin__ = 173;
                    stan::model::assign(St_expert, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                Surv_diff(get_base1(mu, id_trt, "mu", 1), get_base1(mu, id_comp, "mu", 1), alpha, pstream__), 
                                "assigning variable St_expert");
                }
            }
            ...
            lp_accum__.add(uniform_log<propto__>(beta, beta_lower, beta_upper));
            current_statement_begin__ = 183;
            if (as_bool(expert_plus_data)) {
                current_statement_begin__ = 184;
                lp_accum__.add(surv_lognormal_lpdf<propto__>(t, d, multiply(X, beta), alpha, a0, pstream__));
            }
...
typedef model_logNormal_expert_namespace::model_logNormal_expert stan_model;
#ifndef USING_R
