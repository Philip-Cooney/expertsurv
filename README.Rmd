...
knitr::include_graphics("inst/image/Vignette_Example_1_Expert_Opinion.png")
```
...
knitr::include_graphics("inst/image/Vignette_Example_1_DIC.png")
```

```{r echo = FALSE, fig.cap = "Survival function with Expert prior"}
knitr::include_graphics("inst/image/Vignette_Example_1.png")
```
...
knitr::include_graphics("inst/image/Vignette_Example_2.png")
```
...
knitr::include_graphics("inst/image/Vignette_Example_3.png")
```
