...
```
Both visual fit and model fit statistics highlight that the Weibull model is a poor fit to both the expert opinion and data (dashed black line referring to the $95\%$ confidence region for the experts prior belief). 
